...
export class SafeArea {
     ...
     */
    static systemAnimationDuration;
    ...
    static androidCompatMode = false;
     ...
     */
    static safeArea = new StatefulEvent((() => {
        ...
        if (ios.Events && ios.Module) {
            ...
            const dimSub = Dimensions.addEventListener('change', screenHandler);
     ...
     * stateful event that provides the current safe area insets
     */
    static oldSafeArea = new StatefulEvent((() => {
...
export function SafeAreaConsumer(props) {
...
// component: React.ComponentType<Props & SafeAreaInjectedProps>
    ...
    return React.forwardRef((props, ref) => (React.createElement(SafeAreaConsumer, null, (safeArea) => (React.createElement(Component, { safeArea: safeArea, ref: ref, ...props })))));
}
export function withSafeAreaDecorator(component) {
    const Component = component;
    const res = (props) => (React.createElement(SafeAreaConsumer, null, (safeArea) => (React.createElement(Component, { ...props, safeArea: safeArea }))));
...
export class SafeAreaView extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement(SafeAreaConsumer, null, (safeAreaInfo) => {
            ...
            return (React.createElement(View, { pointerEvents: "box-none", ref: this.ref, onLayout: (e) => {
                    if (onLayout)
                        onLayout(e);
                    remeasureLayout();
